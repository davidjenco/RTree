...
public:
    ...
    ///Reads positive int value of number of nearest neighbours to be queried in knn query
    static int readNumberOfNeighbours();
    ...
    ///Reads one point in current dimension from user input
