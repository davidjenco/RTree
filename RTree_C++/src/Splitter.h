...
public:
    static void makeQuadraticSplit(Node & fullNode, Node & node1, Node & node2);
    ...
    static size_t pickNext(Node & fullNode, Node & node1, Node & node2);

    static void quadraticDistribute(Node & fullNode, Node & node1, Node & node2, const size_t & halfNumOfNodes);
